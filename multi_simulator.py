...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_gpr", action='store_true', default=False,
                        help="Use Gaussian Process Regression for performance modeling instead of analytical model")
